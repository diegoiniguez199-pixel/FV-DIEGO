...
def main(page: ft.Page):
    ...
    def card(title, controls):
        return ft.Container(
            content=ft.Column(
                [
                    ft.Container(
                        content=ft.Text(title, size=20, weight=ft.FontWeight.BOLD, color=ft.colors.GREEN_800),
                        padding=8,
    ...
    # --- UI ---
    header = ft.Container(
        content=ft.Text("Predicción de Energía Fotovoltaica", size=28, weight=ft.FontWeight.BOLD, color=ft.colors.WHITE),
